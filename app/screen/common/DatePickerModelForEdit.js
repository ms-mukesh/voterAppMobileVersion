...
import {isANDROID, isIOS, color} from '../../helper/themeHelper';
          ...
          onChange={date => {
            if (date.type != 'dismissed') {
              ...
              pickerMode === 'date'
                ...
                : _setDateFromKey(Moment(date.nativeEvent.timestamp));
          ...
          onChange={date => {
            if (date.type != 'dismissed') {
              if (pickerMode === 'datetime' && date.type === 'set') {
                ...
                _setDateFromKey(Moment(new Date(tempFinalDate.toString()).getTime()));
              } else {
                _setDateFromKey(Moment(date.nativeEvent.timestamp));
              }
