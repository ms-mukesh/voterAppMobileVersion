...
const VoterDetailPreview = props => {
    ...
    const {data,volunteerId} = props.route.params;
    ...
    const insertChangeVoterRequestToDb = () =>{
        ...
        dispatch(applyVolunteerChangesToDb({voterData:voterUpdateObj,volunteerId:volunteerId})).then((res)=>{
            if(res){
                alert("Saved Changes..!")
            }
            ...
            <KeyboardAwareScrollView
                ...
                <View style={{flex: 1}}>
                    <View style={{height:hp(20),alignItems:'center',justifyContent:'center'}}>
                        <TouchableWithoutFeedback style={{height:hp(20),width:hp(20),borderRadius:hp(10)}} onPress={()=>{
                        }}>
                    ...
                    <View style={[style.groupView]}>
                        <View style={[style.innerView]}>
                            ...
                            {User && renderNameFloatingTextForDob( 'Age', User.Age.toString(), "Age", true)}
                        </View>
