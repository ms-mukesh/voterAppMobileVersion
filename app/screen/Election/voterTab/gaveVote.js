...
const VoterWhoGaveVoteScreen = props => {
    const {electionId} = props;
    const voterWhoDoesVote = useSelector(state => state.electionReducer.votedVoter);
                            ...
                            <View style={{flex: 1, justifyContent: 'space-between'}}>
                                ...
                                <View style={{flexDirection:'row',flex:1,justifyContent: 'space-between'}}>
                                    ...
                                    <TouchableWithoutFeedback onPress={()=>{
                                        ...
                                        <View style={{alignItems:'center',justifyContent:'center',height:hp(2.5),width:wp(35),borderRadius:hp(1.5),backgroundColor:color.lightBlue}}>
...
export default VoterWhoGaveVoteScreen;
