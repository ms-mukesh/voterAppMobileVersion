...
import {getVoterListWhoHasNotParticipate} from "../../redux/actions/surveyAction";
...
const VolunteerBoothList = props => {
    ...
    const displayVoterList = (boothId,boothName) =>{
        dispatch(getVoterListWhoHasNotParticipate({boothId,surveyId})).then((res)=>{
           if(res){
               props.navigation.navigate('BoothWiseVoterListForSurvey',{boothName,boothId,surveyId})
           }
        })
    }
