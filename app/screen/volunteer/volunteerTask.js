...
import {fetchVolunteerTask} from "../../redux/actions/volunteerAction";
const VolunteerTaskScreen = props => {
    ...
    const renderEventList = ({item, index}) => {
        return (
            <TouchableOpacity onPress={()=>{
                props.navigation.navigate('VolunteerEventTask',{TaskDataIndex:index})
            }}>
    ...
    return (
        <View style={{flex:1,}}>
            ...
            <FlatList
                ...
                data={TaskInformation.length>0 && TaskInformation}
...
export default VolunteerTaskScreen
